...
filename    = path+'ells/ell_ang_full_Lmin1_Lmax3000_lmin1_lmax8000_lenL100_lenl120_lenang100_1e-02.pkl'
L,l,theta   = pickle.load(open(filename, 'r'))
print min(theta), max(theta)

tag         = 'kkk_fullanalytic_red_dis_lnPs_Bfit_Jias_Simulationsim_comp_3c_Lmin1-Lmax2999-lmax8000-lenBi1200000_post_born_sum'
