...
params,Limber,L1,Int01,Int21,R,bi_cum=pickle.load(open(path+'I0I1I2%s.pkl'%(config),'r'))


pl.figure()
pl.plot(L1,L1**4*Int0*2,ls='-',color='b',label=r'$L^4 \beta^{\mathrm{cross}}_\perp$')
pl.plot(L1,L1**4*Int2*2,ls='-',color='g',label=r'$L^4 \beta^{\mathrm{cross}}_\parallel$')
pl.plot(L1,L1**4*Int01*2,ls='-',color='b',label=r'$L^4 \beta^{\mathrm{cross}}_\perp$')
pl.plot(L1,L1**4*Int21*2,ls='-',color='g',label=r'$L^4 \beta^{\mathrm{cross}}_\parallel$')
