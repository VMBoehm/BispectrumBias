...
config = 'cross_g_linlog_newang_lnPs_Bfit_Planck2013_TempLensCombined_postBornonly'
...
pl.plot(L,L**4*Int0,ls='--',color='k',label=r'$L^4 \beta_0$ N32 cross pB')
pl.plot(L,L**4*Int2,ls=':',color='m',label=r'$L^4 \beta_2$ N32 cross pB')
