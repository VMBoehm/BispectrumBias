...
config = 'cross_g_linlog_newang_lnPs_Bfit_Planck2013_TempLensCombinedpostBorn'
...
pl.plot(L,L**4*Int0,ls='--',color='b',label=r'$L^4$ I0 N32 cross pB')
pl.plot(L,L**4*Int2,ls='--',color='g',label=r'$L^4$ I2 N32 cross pB')
