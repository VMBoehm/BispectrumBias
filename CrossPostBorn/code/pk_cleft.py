...
pkfile = '/home/chirag/Research/Projects/BispectrumBias/CrossPostBorn/data/RunPB/pklin_RunPB.txt'
...
#pk
for zz in np.arange(0.0, 3.5, 0.5):
    print('For z = %0.2f'%zz)
    pk= cpool.make_table(cl, nk=10, npool=32, M=0.2922, z=zz)
    cpool.save_pk(pk, '../data/RunPB/PTdata/pkcleft_zz%03d.dat'%(zz*100))

for zz in np.arange(0.0, 3.5, 0.1):
    print('For z = %0.2f'%zz)
