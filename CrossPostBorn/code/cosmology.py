...
class Cosmology():
    ...
    def __init__(self, M = 0.3, L = None, H0 = 100., B = None, sig8 = 0.8, klin = None, plin = None, pfile = None, Tcmb=2.7, cosmo=None):
        ...
        if cosmo is None:
            self.cosmo = FlatLambdaCDM(H0 = H0, Om0 = M, Tcmb0=Tcmb, Ob0 = B, name = "cosmo")
        else: self.cosmo=cosmo
